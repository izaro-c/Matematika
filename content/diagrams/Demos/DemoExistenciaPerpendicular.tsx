/**
 * Placeholder — Diagrama interactivo del Teorema de existencia de la perpendicular.
 * Pendiente de implementación con JSXGraph vía el skill diagrama.
 */
export const DemoExistenciaPerpendicular = () => {
  return (
