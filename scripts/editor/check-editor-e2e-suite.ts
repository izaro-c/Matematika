...
const expectedFlows = [
  ...
  'Teclado',
  'Documento parcial sin cambios mantiene Guardar deshabilitado',
  'Edición visual localizada y guardado directo',
  'Diagrama no convertible',
  'Diagrama fuente autoritativa',
  'Conflicto de diagrama',
  'Navegación y filtros',
  'Paneles, teclado y responsive',
  'Autoría visual compleja, diagrama y roundtrip',
