...
### Enunciado Formal
<Formula>$$ ... $$</Formula>
Formulación rigurosa con cuantificadores precisos.
...
Todo teorema DEBE:
1. Enunciar el problema rigurosamente
...
1. Ser **completamente rigurosa**. Todo paso debe estar justificado utilizando axiomas o resultados (teoremas, lemas) previamente conocidos y demostrados.
2. **Enunciar explícitamente** las dependencias. Si un paso usa el Axioma de Orden II-3, debe enlazar y mencionar explícitamente el Axioma de Orden II-3.
3. **No asumir ningún paso de por medio**. Evitar frases como "es evidente que" o asumir la existencia de construcciones geométricas (como puntos de intersección o puntos medios) sin recurrir a las herramientas axiomáticas exactas que lo permiten.
4. Dividir la lógica en pasos `MedievalStep` con un título descriptivo y referencias interactivas.
