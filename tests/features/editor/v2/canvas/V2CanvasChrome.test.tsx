...
import { V2CanvasChrome } from '@/features/editor/v2/ui/canvas/V2CanvasChrome';
...
describe('V2CanvasChrome', () => {
  it('hides tool dock when activeTool is select', () => {
    render(<V2CanvasChrome {...defaultProps()} />);
  ...
  it('shows tool dock when activeTool is not select', () => {
    render(<V2CanvasChrome {...defaultProps({ activeTool: 'point' })} />);
  ...
  it('calls onResetViewport when Centrar is clicked', () => {
    ...
    render(<V2CanvasChrome {...defaultProps({ onResetViewport })} />);
