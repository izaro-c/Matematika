...
import { V2GroupsAndLayersManager } from '@/features/editor/v2/ui/V2GroupsAndLayersManager';

describe('V2GroupsAndLayersManager layer moves', () => {
  it('moves an item to another layer via the layer select', () => {
    ...
    render(<V2GroupsAndLayersManager model={model} onUpdateModel={onUpdateModel} />);
