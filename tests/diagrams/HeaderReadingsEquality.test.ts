...
describe('Header Readings Equality Behavior', () => {
  const baseSpec: DiagramSpecV2 = {
    ...
    points: [
      { id: 'A', label: 'A', x: 0, y: 0, color: 'salvia', selection: { selectable: true } },
      { id: 'B', label: 'B', x: 4, y: 0, color: 'salvia', selection: { selectable: true } },
      { id: 'C', label: 'C', x: 4, y: 3, color: 'salvia', selection: { selectable: true } },
    ],
    elements: [
      {
        id: 'dimAB',
