...
import { MedievalStep } from "@/boundary/components/content/MedievalStep";
import { DemonstrationSection } from "@/boundary/components/content/DemonstrationSection";
import { Concept } from "@/boundary/components/content/Concept";
import { Paso } from '@/boundary/components/exercises/Paso';
import { Solucion } from '@/boundary/components/exercises/Solucion';
import { Pregunta } from '@/boundary/components/exercises/Pregunta';
import { Hueco } from '@/boundary/components/exercises/Hueco';
import { ErrorComun } from '@/boundary/components/exercises/ErrorComun';
import { Emparejar } from '@/boundary/components/exercises/Emparejar';
import { CanvasInteractivo } from '@/boundary/components/exercises/CanvasInteractivo';
import { Clasificador } from '@/boundary/components/exercises/Clasificador';
import { Ordenacion } from '@/boundary/components/exercises/Ordenacion';
import { MatrizInteractiva } from '@/boundary/components/exercises/MatrizInteractiva';
import { DeslizadorEnLine, DynamicValue } from '@/boundary/components/exercises/DeslizadorEnLine';
import { HighlightLink } from '@/boundary/components/ui/HighlightLink';
import { ConceptLink } from "@/boundary/components/ui/ConceptLink";
import { RefLink } from "@/boundary/components/ui/RefLink";
import { GlossaryLink } from '@/boundary/components/ui/GlossaryLink';
import { VisualBind, InteractiveElement } from '@/boundary/components/ui/VisualBind';
