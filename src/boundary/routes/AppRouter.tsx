...
import { MathProvider } from "@/boundary/contexts/MathStoreContext";
import { Suspense, lazy } from 'react';
import { HomePage } from "@/boundary/pages/Home/HomePage";
import { DictionaryPage } from "@/boundary/pages/DictionaryPage";
import { HistoryTimeline } from "@/boundary/pages/HistoryTimeline";
import { BranchPage } from "@/boundary/pages/BranchPage";
import { TheoremPage } from "@/boundary/pages/TheoremPage";
import { DefinitionPage } from "@/boundary/pages/DefinitionPage";
import { ExamplePage } from "@/boundary/pages/ExamplePage";
import { ExercisePage } from "@/boundary/pages/ExercisePage";
import { StudyPlanPage } from "@/boundary/pages/StudyPlanPage";
import { MethodsPage } from "@/boundary/pages/MethodsPage";
import { UseCasePage } from "@/boundary/pages/UseCasePage";
import { AxiomPage } from "@/boundary/pages/AxiomPage";
import { ModelPage } from "@/boundary/pages/ModelPage";
import { AxiomaticSystemPage } from "@/boundary/pages/AxiomaticSystemPage";
import { DemoPage } from "@/boundary/pages/DemoPage";
import { NotFoundPage } from "@/boundary/pages/NotFoundPage";
import { ConstructionPage } from "@/boundary/pages/ConstructionPage";
import { InteractiveLessonLayout } from "@/boundary/components/layout/InteractiveLessonLayout";
import { BiographyLayout } from "@/boundary/components/layout/BiographyLayout";
import { Logo } from "@/boundary/components/ui/Logo";
import { db } from '@/database/dao/content';

const EditorPage = lazy(() => import("@/boundary/pages/Editor/EditorPage").then(m => ({ default: m.EditorPage })));
const GraphPage = lazy(() => import("@/boundary/pages/GraphPage").then(m => ({ default: m.GraphPage })));
const AxiomGraphPage = lazy(() => import("@/boundary/pages/AxiomGraphPage").then(m => ({ default: m.AxiomGraphPage })));
