...
import type { AreaMembership } from '@/diagrams/spec/types';
...
import { withResolvedPointConstraints } from '@/diagrams/spec/scene';
import { computeHalfPlaneSide } from '@/diagrams/spec/areaGeometry';
