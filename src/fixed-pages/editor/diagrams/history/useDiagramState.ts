...
import { diagramReducer, initialDiagramState } from '@/fixed-pages/editor/diagrams/history/reducer';
import { diagramRepository } from '@/fixed-pages/editor/diagrams/save/repository';
import { generateDiagramSource } from '../source/generator';
import { parseDiagramSourceOnServer } from '../source/parser';
import { getDiagramSaveCapability, isDiagramStateDirty } from '../model/scene/selectors';
import type { VisualDiagramModel, CanvasTool } from '../model/types';
import { asPersistenceError } from '@/fixed-pages/editor/save/persistenceErrors';
