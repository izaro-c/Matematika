...
export const KIND_LABELS: Record<ElementKind, string> = {
  ...
  intersection: 'Intersección', midpoint: 'Punto medio', perpendicularFoot: 'Pie perpendicular', segmentExtension: 'Extensión de segmento', perpendicular: 'Perpendicular', parallel: 'Paralela',
