import type { ContentVersion, EditorFileIdentity, LocalRevision } from '@/fixed-pages/editor/save/persistenceContracts';
import type { PersistenceError } from '@/fixed-pages/editor/save/persistenceErrors';
