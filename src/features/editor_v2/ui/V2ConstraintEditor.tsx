...
import type { VisualDiagramModel, VisualConstraint } from '../../editor/diagrams/model/types';
import {
  RELATION_CATALOG,
...
import { IconClose, IconPlus, IconTrash } from './V2Icons';

interface V2ConstraintEditorProps {
  model: VisualDiagramModel | null;
  selectedId?: string;
  onUpdateModel: (nextModel: VisualDiagramModel, label: string) => void;
}

export const V2ConstraintEditor: React.FC<V2ConstraintEditorProps> = ({
  model,
  selectedId,
  onUpdateModel,
}) => {
