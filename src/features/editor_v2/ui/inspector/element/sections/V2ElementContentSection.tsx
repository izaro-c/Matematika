...
import { DiagramTextRulesEditor } from '@/features/editor/diagrams/ui/DiagramTextRulesEditor';
import { DiagramInfoPanelContentEditor } from '@/features/editor/diagrams/ui/DiagramInfoPanelContentEditor';
...
export const V2ElementContentSection: React.FC<V2ElementPanelProps> = ({
  model,
  element,
  onUpdateElement,
}) => {
