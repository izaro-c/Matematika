...
export const PointLabelHelp: React.FC = () => (
  <div className="mt-2 p-2.5 bg-salvia/5 rounded-xl border border-salvia/20 text-[10px] text-carbon/80 space-y-1 font-serif">
    <div className="flex items-center space-x-1">
      <span className="font-bold text-salvia text-[11px]">Formato de Etiqueta de Punto</span>
    </div>
...
export const TextContentHelp: React.FC = () => (
  <div className="mt-2 p-2.5 bg-salvia/5 rounded-xl border border-salvia/20 text-[10px] text-carbon/80 space-y-1.5 font-serif">
    <div className="flex items-center space-x-1">
      <span className="font-bold text-salvia text-[11px]">Guía de Formato de Texto & Fórmulas</span>
    </div>
    <ul className="list-disc pl-4 space-y-1 leading-tight text-carbon/75">
