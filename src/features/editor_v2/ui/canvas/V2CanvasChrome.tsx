...
import { V2ToolDrawing, IconClose, IconChevronLeft, IconChevronRight } from '../V2Icons';
...
export const V2CanvasChrome: React.FC<V2CanvasChromeProps> = ({
  model,
  activeTool,
  pendingRefs,
  stepCount,
        ...
        <div className="absolute top-3 left-3 z-30 flex flex-col gap-2 max-w-sm pointer-events-auto">
          <div className={`flex items-start gap-2.5 px-3 py-2 ${dockShell}`}>
            <div className="mt-0.5 text-salvia shrink-0">
              <V2ToolDrawing tool={activeTool} className="w-4 h-4" />
            </div>
