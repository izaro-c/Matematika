...
import type { CanvasTool } from '../../editor/diagrams/model/types';
 ...
 */
export const V2ToolDrawing: React.FC<{ tool: CanvasTool | 'add_slider' | 'add_step' | 'guided' | 'add_glider' | string; className?: string }> = ({ tool, className = "w-4 h-4" }) => {
