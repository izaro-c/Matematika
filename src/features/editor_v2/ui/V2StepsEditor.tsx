...
import type { VisualDiagramModel, VisualStep } from '../../editor/diagrams/model/types';
import type { DiagramStepEmphasis } from '@/shared/diagrams/spec';
import { toggleInitialStep, duplicateStep, moveStep } from '../../editor/diagrams/model/diagramElements';
import { syncStepObjectVisibility } from './editorV2Selection';
import { DiagramStepObjectAppearanceEditor } from '../../editor/diagrams/ui/DiagramStepObjectAppearanceEditor';
import { IconPlus, IconTrash, IconCopy, IconChevronUp, IconChevronDown } from './V2Icons';

interface V2StepsEditorProps {
...
export const V2StepsEditor: React.FC<V2StepsEditorProps> = ({
  model,
  activeStepIndex,
  selectedIds = [],
  onSelectStepIndex,
