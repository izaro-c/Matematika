...
import { useDiagramState } from '../../editor/diagrams/hooks/useDiagramState';
import { useDiagramDiagnostics } from '../../editor/diagrams/hooks/useDiagramDiagnostics';
import { useDiagramClipboard } from '../../editor/diagrams/hooks/useDiagramClipboard';
import { useWorkbenchKeyboard } from '../../editor/diagrams/hooks/useWorkbenchKeyboard';
import { createTemplateModel } from '../../editor/diagrams/model/templateModels';
import { useDiagramWorkbenchLoader, type DiagramWorkbenchMode } from '../../editor/diagrams/hooks/useDiagramWorkbenchLoader';
import type {
  CanvasTool,
  TemplateKind,
  VisualPoint,
  ...
  VisualDiagramModel,
  ElementKind,
} from '../../editor/diagrams/model/types';
import {
  refsNeededForTool,
...
} from '../../editor/diagrams/model';
import { makeVisibleInEveryStep } from '../../editor/diagrams/hooks/useWorkbenchActions';
...
import { DiagramConfirmDialog } from '../../editor/diagrams/ui/DiagramConfirmDialog';
import { DiagramDivergenceDialog } from '../../editor/diagrams/ui/DiagramDivergenceDialog';
import { DiagramStatusBar } from '../../editor/diagrams/ui/DiagramStatusBar';
import {
  effectiveSelection,
