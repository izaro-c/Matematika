...
import type { VisualDiagramModel, VisualPoint, VisualElement, VisualSlider } from '../../editor/diagrams/model/types';
import { PALETTE_TOKENS } from './inspector/paletteTokens';
import { V2GroupsAndLayersManager } from './V2GroupsAndLayersManager';
import { IconEye, IconEyeOff, IconLock, IconUnlock, IconChevronDown, IconChevronRight } from './V2Icons';
import { ObjectListBatchToolbar } from '../../editor/diagrams/ui/scene/ObjectListBatchToolbar';

interface V2SceneTreeProps {
...
export const V2SceneTree: React.FC<V2SceneTreeProps> = ({
  model,
  selectedIds,
  onSelectObjects,
  onUpdatePoint,
  ...
  return (
    <div className="p-3 space-y-2 text-xs font-serif text-carbon">
      ...
      {viewMode === 'groups_layers' && onUpdateModel ? (
        <V2GroupsAndLayersManager model={model} onUpdateModel={onUpdateModel} />
      ) : (
        <div className="space-y-1">
          {/* Puntos */}
