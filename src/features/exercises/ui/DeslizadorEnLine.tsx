  ...
  return (
    <span className="inline-flex items-center gap-2 bg-lienzo border border-carbon/20 px-2 py-0.5 font-serif my-1 transition-colors align-middle relative top-[-1px]">
      ...
      <input
        ...
        className="page-accent-range w-20 h-px bg-carbon/40 appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-[4px] [&::-webkit-slider-thumb]:h-[12px] [&::-webkit-slider-thumb]:transition-colors"
      />
    </span>
  );
};
