...
/**
 * Componente interactivo para ejercicios de agrupación/clasificación lógica.
 * 
 * Presenta una bandeja con ítems desordenados y varias categorías (buckets).
 * Por ejemplo: Arrastrar ecuaciones a "Lineales" o "Cuadráticas".
 * El estudiante debe arrastrar o mover los ítems al contenedor correcto.
 * Informa al `ExerciseContext` si la clasificación general es correcta.
 */
