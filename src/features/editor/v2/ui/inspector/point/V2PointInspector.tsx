...
import type { VisualPoint } from '@/features/editor/diagrams/model/types';
...
import type { V2PointPanelProps } from '../types';
import { availableLayers, handleRenameId } from '../utils';
import { DiagramDerivedPositionEditor } from '@/features/editor/diagrams/ui/DiagramDerivedPositionEditor';
import { DiagramNativeLabelEditor } from '@/features/editor/diagrams/ui/DiagramNativeLabelEditor';
import { DiagramPointMovementAidsEditor } from '@/features/editor/diagrams/ui/DiagramPointMovementAidsEditor';
import { supportElements } from '@/features/editor/diagrams/model';
import { parseOptionalNumber } from '../../editorV2Selection';
import { V2ConstraintEditor } from '../../V2ConstraintEditor';

export const V2PointInspector: React.FC<V2PointPanelProps & {
