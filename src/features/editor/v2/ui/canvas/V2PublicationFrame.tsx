...
const MODE_LABELS: Record<V2PublicationFrameProps['mode'], string> = {
  desktop: 'Escritorio',
  tablet: 'Tableta',
  mobile: 'Móvil',
};

function bezelClassName(mode: V2PublicationFrameProps['mode']): string {
  switch (mode) {
    case 'mobile':
...
export const V2PublicationFrame: React.FC<V2PublicationFrameProps> = ({
  mode,
  title,
  pageType,
  children,
