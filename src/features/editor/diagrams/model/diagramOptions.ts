...
export const KIND_LABELS: Record<ElementKind, string> = {
  ...
  angleBisector: 'Bisectriz', angle: 'Ángulo orientado', nonReflexAngle: 'Ángulo no reflejo (≤ 180°)', rightAngle: 'Ángulo recto', congruenceMark: 'Marca de congruencia', measureTicks: 'Marcas de medida', perpendicularMark: 'Marca de perpendicularidad',
