    ...
    <>
      ...
      {selectedElement.kind === 'functionCurve' && (
        <fieldset className="space-y-3 border-t border-carbon/10 pt-3">
          <legend className="mb-2 text-[10px] font-bold uppercase tracking-wider text-carbon/50">Área</legend>
      ...
      {(['functionCurve', 'parametricCurve'].includes(selectedElement.kind)) && (
        <fieldset className="grid grid-cols-2 gap-2 border-t border-carbon/10 pt-3">
          <legend className="mb-2 text-[10px] font-bold uppercase tracking-wider text-carbon/50">Dominio y muestreo</legend>
