...
export const DIAGRAM_PALETTE_TOKENS: {
  ...
  { id: 'mora', name: 'Morado', bgClass: 'bg-mora', textClass: 'text-mora', borderClass: 'border-mora' },
  ...
  { id: 'canela', name: 'Naranja', bgClass: 'bg-canela', textClass: 'text-canela', borderClass: 'border-canela' },
