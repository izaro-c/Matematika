...
```ts
import { THEME_COLOR_VARS, SEMANTIC_COLOR_ROLES, DIAGRAM_PALETTE_TOKENS } from '@/design';
```

## Anti-patrón

Duplicar listas `carbon/canela/…` o `#hex` en features. Si hace falta una etiqueta UI, deriva de estos tokens.
