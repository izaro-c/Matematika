import type { DiagramElement, DiagramElementKind, DiagramPoint, DiagramSceneItem, DiagramSlider } from '@/diagrams/model/schema/types';
import type { DiagramObject } from '@/diagrams/model/schema/v3';
