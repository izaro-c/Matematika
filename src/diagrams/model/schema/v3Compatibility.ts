...
import { extractMathExpressionIdentifiers } from '@/diagrams/model/expressions/expressions';
...
import { DIAGRAM_RENDERER_V2_ID, DIAGRAM_SPEC_V2_VERSION } from '@/diagrams/model/schema/types';
import type {
  AngleObject,
  AnnotationObject,
  ControlObject,
