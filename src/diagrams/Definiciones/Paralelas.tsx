...
export const Paralelas = () => {
  ...
  useEffect(() => {
    ...
    elementsRef.current = { pA, pB, rectaBase, puntoP, rectaParalela, board };
  ...
  useEffect(() => {
    const { pA, pB, rectaBase, puntoP, rectaParalela, board } = elementsRef.current as Record<string, any>;
    if (!board) return;
