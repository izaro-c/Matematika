...
export const Perpendicular = () => {
  ...
  useEffect(() => {
    ...
    elementsRef.current = { pA, pB, recta1, puntoC, recta2, a1, a2, a3, a4, board };
  ...
  useEffect(() => {
    const { pA, pB, recta1, puntoC, recta2, a1, a2, a3, a4, board } = elementsRef.current as Record<string, any>;
    if (!board) return;
