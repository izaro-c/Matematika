...
import {computeAutoFitBounds, fitVisibleItemsAtStep, offscreenVisibleItemIds, resolveHomeViewport, resolveInitialCamera, normalizeViewportBounds, type ViewportChangeOptions} from '@/diagrams/geometry';
