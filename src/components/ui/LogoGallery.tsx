/**
 * Componente interactivo que muestra una galería de 10 variaciones del logotipo
 * utilizando distintas geometrías, paletas de color y tipografías extravagantes/medievales.
 * Sirve principalmente como un tablero de pruebas de diseño tipográfico.
 */
  ...
  return (
    <div className="w-full max-w-7xl mx-auto py-12 px-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
        ...
        {/* 1. El Clásico */}
        <div className="flex flex-col items-center bg-lienzo p-6 rounded-none shadow-sm border border-carbon/10">
