    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-screen bg-lienzo flex items-center justify-center p-8 font-serif text-carbon">
          <div className="max-w-xl border-l-4 border-red-500 pl-6 py-4 bg-white/50 shadow-sm">
            <h2 className="text-xl font-bold mb-2 text-red-700">Error de renderizado</h2>
