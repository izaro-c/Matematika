...
export const ThemeToggle = () => {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="fixed top-6 right-6 z-50 w-12 h-12 flex items-center justify-center rounded-full border border-carbon/20 bg-lienzo text-carbon shadow-sm hover:shadow-md transition-all hover:scale-105"
