...
export { dictionary, texSymbolMap } from '@/database/config/glossaryDictionary';
export type { GlossaryEntry, GlossaryCategory } from '@/database/config/glossaryDictionary';
