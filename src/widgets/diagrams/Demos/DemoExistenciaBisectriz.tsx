...
export const DemoExistenciaBisectrizSpec = createDiagramSpec(
{
  "version": 3,
  "renderer": "matematika-diagram-renderer-v3",
  "title": "Existencia de la bisectriz",
  "componentId": "demo-existencia-bisectriz",
  "category": "Demos",
  "mode": "simulation",
  "axis": false,
  "grid": false,
...
export const DemoExistenciaBisectriz = () => <DiagramRenderer spec={DemoExistenciaBisectrizSpec} />;
