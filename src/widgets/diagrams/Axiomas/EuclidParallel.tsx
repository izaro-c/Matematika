...
export const EuclidParallel = () => {
  ...
  const onInit = (board: any, els: any, theme: any) => {
      ...
      const lineL = createLine(board, [[-4, 2], [4, 1.5]], {
      strokeColor: theme.carbon, strokeWidth: 2.5,
    }, theme);

    createText(board, [4.2, 1.8, 'l'], {
      fontSize: 14, fillColor: theme.lienzo, highlightFillColor: theme.lienzo,
    }, theme);
    ...
    createText(board, [4.2, function() { return pP.Y() - 0.3; }, 'm'], {
      fontSize: 14, fillColor: theme.lienzo, highlightFillColor: theme.lienzo,
    }, theme);
  ...
  const onUpdate = (board: any, els: any, theme: any, isStep: any, isHL: any) => {
      ...
      const { lineL, pP, lineM } = els;
      lineL.setAttribute({ strokeColor: theme.carbon, strokeWidth: 2.5 });
